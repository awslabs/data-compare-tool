...
function DVTTable(props) {
    ...
    const [modalDetailsDataRowIndex, setModalDetailsDataRowIndex] =
        useState(-1);
    ...
    function isUnsavedDataExist() {
        return data["unsavedRows"] !== undefined &&
            data["unsavedRows"].length > 0
            ? true
            : false;
    }
    ...
    function applyDetailsModalHandler(modalData) {
        ...
        if (clonedDeta["unsavedRows"] === undefined) {
            ...
            if (
                clonedDeta["unsavedRows"].indexOf(modalDetailsDataRowIndex) ===
                -1
            ) {
