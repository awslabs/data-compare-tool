...
function DVTTableModal(props) {
    ...
    const handleChange = (event) => {
        ...
        var clonedmodalDetailsData = JSON.parse(
            JSON.stringify(modalDetailsData)
        );
                        ...
                        if (eachColMetaData.type === "Integer") {
                            if (isNaN(eachCol.targetValue)) {
                                ...
                                setValidationMessage(
                                    eachCol.colName + " should be Integer"
                                );
                            }
        ...
        <div>
            ...
            >
                <Box sx={style}>
                    <span>
                        {
                            <Button onClick={copyAllFrmSrcToTarget}>
                                Src To Target
                            </Button>
                        }
                    </span>
                    ...
                    <div>
                        ...
                        {modalDetailsData === [] ? null : (
                            <TableContainer component={Paper}>
                                <Table aria-label="Table" className="dvttbl">
                                    <TableHead>
                                        <TableRow>
