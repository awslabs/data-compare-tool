...
In case if any mismatch of data found, then it generates separate .html file for each table. Filename format is <<schema*name>>*<<table*name>>\_table_comparison_result*<<yyyy-MM-DD*HH-mm>>.html. Navigation link is available to this page from data_comparison_result*<<yyyy-MM-DD_HH-mm>>.html page in that respective row. Also it contains link Detailed Report In CSV for these data in csv format.
...
-   Detailed Report filename format is <<schema*name>>*<<table*name>>\_table_comparison_result*<<yyyy-MM-DD_HH-mm>>.csv
