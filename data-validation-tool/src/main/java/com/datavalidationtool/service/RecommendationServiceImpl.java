...
public class RecommendationServiceImpl implements RecommendationService{
    ...
    public List<RunDetails> getRunDetails(RunDetails inputRunDetails_1, DatabaseInfo databaseInfo) throws Exception {
        ...
        if(inputRunDetails_1.getRun() !=0){
            queryWithOptionalParam = queryWithOptionalParam+ "and run='"+inputRunDetails_1.getRun()+"' ";
        }
        ...
        try (Connection dbConn = getConnection(databaseInfo);
            ...
            while (rs.next()) {
                ...
                runDetails.setRun(rs.getInt("run"));
    ...
    public int insertRunDetailsRecord(RunDetails inputRunDetails_1, DatabaseInfo databaseInfo) throws Exception {
        int updateResult=0;
        String insertQuery = "Insert into public.run_details ( source_host_name,target_host_name,database_name,schema_name, table_name,run, execution_date)";
